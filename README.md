...
2. [VSCodium](https://vscodium.com/) - fork VS Code bez telemetrie od Microsoftu.
3. [DOXA Notes](https://doxa-notes.org) - lokální textový zápisník myšlenek.
4. [CherryTree](https://www.giuspen.net/cherrytree/) - textový editor.

## 📀 Můj nejoblíbenější software a služby:
* [FileZilla](https://filezilla-project.org) přenos souborů přes FTP.
* [Firefox](https://www.mozilla.org/cs/firefox/new/) pro mě jednička mezi webovými prohlížeči.
...
* [📄 Insula Faktura](https://faktury.lukan.cz/) - generátor faktur vytvořte profesionální faktury přímo ve svém prohlížeči. Data zůstávají jen u vás. Aplikace plně vyvinuta pomocí AI bez paid.
